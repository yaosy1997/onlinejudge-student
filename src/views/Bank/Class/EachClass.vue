    ...
    <Row>
              ...
              <div style="text-align:left;">
                ...
                <Row style="margin-top:1.3vw">
                  <i-col span="10">
                    ...
                    <span style="margin-left:19px;font-size:16px;font-weight:600;">{{total}}</span><span style="margin-left:3px;font-size:12px;color：#e5e5e5">项</span>
                    </div>
                  </i-col>
                  <i-col span="14">
      ...
      <i-col span="7">
        <div name="percent" class="box" style="height:150px">
          ...
          <i-circle :percent="jindu" dashboard size="100" style="margin-top:10px">
            <span class="demo-circle-inner" style="font-size:24px">{{jindu}}%</span>
          </i-circle>
          <p></p>
        </div>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      jindu(){
        return (this.$store.state.user.summary.jindu*100).toFixed(2)
      },
      total(){
        let a=0;
        this.classQuestion.map(arr=>{
