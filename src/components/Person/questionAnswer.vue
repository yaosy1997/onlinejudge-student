        ...
        <Layout style="margin-right: auto; margin-left: auto;width: 1000px">
            <Content :style="{padding: '0 50px'}">
                <Breadcrumb :style="{margin: '20px 0'}">
                    <BreadcrumbItem to="question">题库</BreadcrumbItem>
                </Breadcrumb>
                ...
                <Card>
                    <div style="min-height: 200px;">
                        ...
                        <div style="margin-left:30px;margin-top:10px;">
                            <h2 style="font-weight:400;color: #2E8FFF">{{ AnswerInfo.question.question_name}}</h2>
                        ...
                        <div style="width: 800px;border-bottom: #707070 1px solid;margin-left: 35px;font-size: 22px;margin-top: 30px">
                            解决方案
                        </div>
